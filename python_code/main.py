...
class Матрица:
    ...
    def __pow__(конкретная_матрица, степень, modulo=None):
        новая_матрица = конкретная_матрица.копия()
        if степень == 0:
            новая_матрица.заполнить_до_единичной()
            return новая_матрица
        elif степень == 1:
            return новая_матрица
        elif степень == -1:
            if определитель(новая_матрица) == 0:
                raise ArithmeticError("Невозможно найти обратную матрицу так как определитель равен нулю")
            else:
                return новая_матрица.алгебраические_дополнения.транспонированная / определитель(новая_матрица)
        elif степень > 1:
            return новая_матрица * новая_матрица ** (степень - 1)
        else:
            новая_матрица = новая_матрица ** (-1)
            return новая_матрица ** (-степень)
